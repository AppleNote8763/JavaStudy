...
//			if (genderCkeck == 1) {
//				humanInformation[i].setGender("남");
//			}else if (genderCkeck == 2) {
//				humanInformation[i].setGender("여");
//			}
//			System.out.print("이름을 입력하세요 : ");
//			humanInformation[i].setName(scanner.nextLine());
//			System.out.println();
//			System.out.print("나이를 입력하세요 : ");
//			humanInformation[i].setAge(scanner.nextInt());
//		}
//		
//		for (int i = 0; i < humanInformation.length; i++) {
//			System.out.println(humanInformation[i].getName());
//		}
	}
